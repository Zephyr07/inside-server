...
<div class="row-fluid">
    <div
        ...
        <div class="col-lg-2 col-sm-2 col-md-2 col-lg-offset-5 col-sm-offset-5 col-md-offset-5"
            ...
            <img src="{{url("img/logo_cc.png")}}" class="logo" style="width: 100%;vertical-align: middle;border: 0;box-sizing: border-box" alt="logo Cash and Carry">
        </div>

        <div class="clearfix" style="clear: both;">
            <br>
        </div>
        <div class="col-lg-6 col-sm-6 col-md-6 col-lg-offset-3 col-sm-offset-3 col-md-offset-3 p"
